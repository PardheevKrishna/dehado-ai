...
IMAGES_DIR       = "../data"           # directory with input images
OUTPUT_DIR       = "../output_json_files"              # where to save JSONs and summary
YOLO_MODEL_PATH  = "../model/best_yolov8s.pt"         # your trained YOLOv8 model
DONUT_MODEL_NAME = "naver-clova-ix/donut-base"
DONUT_CHECKPOINT = "../model/donut_best_checkpoint.pt"
MAX_LENGTH       = 256
NUM_BEAMS        = 5
